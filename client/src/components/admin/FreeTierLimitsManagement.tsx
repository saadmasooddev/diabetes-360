...
import {
	...
	useLimits,
	useUpdateLimits,
} from "@/hooks/mutations/useSettings";
...
export function FreeTierLimitsManagement() {
	...
	const [discountedConsultationQuota, setDiscountedConsultationQuota] =
		useState<string>("0");
	const [freeConsultationQuota, setFreeConsultationQuota] =
		useState<string>("0");
	...
	useEffect(() => {
		if (limits) {
			...
			setDiscountedConsultationQuota(
				String(limits.discountedConsultationQuota || 0),
			);
		...
		>
			<CardHeader className="p-4 sm:p-6">
				...
				<CardDescription className="text-sm">
					Configure daily logging limits for health metrics, food scanning, and
					consultation quotas for new users.
				</CardDescription>
			</CardHeader>
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
							<div className="space-y-2">
								...
								<p className="text-xs text-gray-500">
									Maximum number of glucose logs free tier users can create per
									day
								</p>
							</div>
							...
							<div className="space-y-2">
								...
								/>
								<p className="text-xs text-gray-500">
									Maximum number of steps logs free tier users can create per
									day
								</p>
							</div>
							...
							<div className="space-y-2">
								...
								/>
								<p className="text-xs text-gray-500">
									Maximum number of water intake logs free tier users can create
									per day
								</p>
							</div>
						</div>
						...
						<div className="pt-4 border-t">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
								<div className="space-y-2">
									...
									/>
									<p className="text-xs text-gray-500">
										Number of discounted consultations (20% off) available for
										new paid users
									</p>
								</div>
								...
								<div className="space-y-2">
									...
									/>
									<p className="text-xs text-gray-500">
										Number of free consultations available for new annual paid
										users
									</p>
								</div>
							</div>
							<p className="text-xs text-gray-500 mt-2">
								Note: These quotas apply to all new users. Existing users will
								continue on their old quotas.
							</p>
						</div>
						...
						<div className="pt-4">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
								...
								<div className="space-y-2">
									...
									/>
									<p className="text-xs text-gray-500">
										Maximum number of food scans per day for paid users
