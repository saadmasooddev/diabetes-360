...
export const exercisePlans: ExercisePlan[] = [
  {
    ...
    description: "Improves insulin sensitivity and lowers blood sugar after meals.",
  ...
  },
  {
    ...
    duration: "15-30 minutes",
    description: "Strength training improves muscle mass, which helps your body use insulin more efficiently.",
  ...
  },
  {
    ...
    duration: "15-30 minutes",
    description: "Yoga reduces stress and lower blood sugar, plus improves flexibility and mobility.",
