...
function transformFormDataToAPI(data: ProfileDataFormValues | Partial<ProfileDataFormValues>): any {
  ...
  if (data.birthDay && data.birthMonth && data.birthYear) {
    apiData.birthday = combineDateFields(data.birthDay, data.birthMonth, data.birthYear);
  }

  // Transform diagnosis date fields
  if (data.diagnosisDay && data.diagnosisMonth && data.diagnosisYear) {
    apiData.diagnosisDate = combineDateFields(data.diagnosisDay, data.diagnosisMonth, data.diagnosisYear);
  }
