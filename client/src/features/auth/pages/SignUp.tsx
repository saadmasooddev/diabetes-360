			...
			<section className="w-full lg:w-1/2 lg:flex-shrink-0 lg:h-full bg-white lg:bg-[#f7f9f9] flex items-center justify-center px-4 py-8 lg:py-12 lg:overflow-y-auto">
				<div className="w-full max-w-[447px] flex flex-col lg:my-auto">
					...
					<form onSubmit={handleSubmit(onSubmit)}>
						...
						<div className="flex flex-col gap-1.5 mb-[16px]">
							...
							<div className="relative w-full lg:w-[353px]">
								<Input
									...
									placeholder="John"
									maxLength={100}
									className={`w-full h-auto pl-4 ${isFirstNameValid ? "pr-12" : "pr-4"} py-[18px] bg-white rounded-[10px] border border-solid ${
										errors.firstName ? "border-red-500" : "border-[#d8dadc]"
								...
								{isFirstNameValid && (
									<CheckIcon
										...
										data-testid="icon-firstname-valid"
									/>
								)}
							</div>
							{errors.firstName && (
						...
						<div className="flex flex-col gap-1.5 mb-[16px]">
							...
							<div className="relative w-full lg:w-[353px]">
								<Input
									...
									placeholder="Doe"
									maxLength={100}
									className={`w-full h-auto pl-4 ${isLastNameValid ? "pr-12" : "pr-4"} py-[18px] bg-white rounded-[10px] border border-solid ${
										errors.lastName ? "border-red-500" : "border-[#d8dadc]"
									} [font-family:'Inter',Helvetica] font-normal text-black text-base truncate`}
									{...register("lastName")}
								...
								{isLastNameValid && (
									<CheckIcon
										className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#00856f] pointer-events-none"
										data-testid="icon-lastname-valid"
									/>
								)}
							</div>
							{errors.lastName && (
						...
						{errors.agreeToTerms && (
							<span
								className="text-red-500 text-sm [font-family:'Inter',Helvetica] block -mt-4 mb-4"
