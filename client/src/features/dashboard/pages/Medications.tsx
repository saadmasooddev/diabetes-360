...
export function Medications() {
        ...
        <main className="flex-1 px-4 sm:px-6 lg:px-8 py-8">
          <div className="w-full max-w-[1200px] mx-auto">
            <Card className="p-6 text-center">
              <p className="text-gray-500">Invalid parameters. Please go back to medical records.</p>
              <Button onClick={handleBack} className="mt-4" style={{ background: '#00856F', color: '#FFFFFF' }}>
                Go Back
              </Button>
            </Card>
          </div>
  ...
  const date = data?.prescriptionDate ? formatDate(new Date(data.prescriptionDate), 'MMM dd, yyyy') : '';
          ...
          <div className="mb-6">
            ...
            {physician && date && (
              ...
              >
                ...
                {physician.specialty ? ` - ${physician.specialty}` : ''} on {date}
              </p>
            )}
          </div>
          ...
          {isLoading ? (
            ...
            <div className="space-y-4">
              {medications.map((medication) => (
                ...
                >
                  <div className="space-y-4">
                    {(medication.medicines as Medicine[]).map((medicine, index) => (
                      <div
                        key={index}
