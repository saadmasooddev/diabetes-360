...
export function DoctorSearchStep({
  ...
  return (
    <div className="w-full max-w-[1100px] px-4 sm:px-6 lg:px-8">
      <DoctorSearchBar searchQuery={searchQuery} onSearchChange={onSearchChange} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6" data-testid="section-doctors-grid">
        {isLoadingPhysicians ? (
