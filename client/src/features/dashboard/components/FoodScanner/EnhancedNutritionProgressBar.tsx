...
export function EnhancedNutritionProgressBar({
	...
	const consumedPercent =
		recommendedValue > 0
			? Math.min((consumedValue / recommendedValue) * 100, 100)
			: 0;
	const currentPercent =
		recommendedValue > 0
			? Math.min((currentValue / recommendedValue) * 100, 100)
			: 0;
	const totalPercent =
		recommendedValue > 0
			? Math.min((totalConsumed / recommendedValue) * 100, 100)
			: 0;
					...
					{consumedValue > 0 && (
						<div
							...
							style={{
								...
								zIndex: 1,
								borderRadius:
									currentValue > 0 && consumedPercent < 100
										? "4px 0 0 4px"
										: "4px",
							}}
						/>
