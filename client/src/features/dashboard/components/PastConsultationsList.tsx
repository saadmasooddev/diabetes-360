...
export function PastConsultationsList({ limit = 2, showSeeAll = true }: PastConsultationsListProps) {
  ...
  if (pastConsultations.length === 0) {
    return (
      <Card className="p-4 sm:p-6 text-center text-gray-500 text-sm sm:text-base" style={{ background: '#FFFFFF', border: '1px solid rgba(0, 0, 0, 0.1)', borderRadius: '12px' }}>
