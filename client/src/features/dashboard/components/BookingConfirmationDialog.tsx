...
export function BookingConfirmationDialog({
	...
	const effectiveSlotTypeId =
		selectedSlotTypeId || autoSelectedSlotTypeId || null;
			...
			<DialogContent className="sm:max-w-[450px]">
						...
						{selectedSlot.types && selectedSlot.types.length > 0 && (
							<div>
								...
								<div className="p-4 rounded-lg border border-[#00856F] bg-[#E0F2F1]">
									...
									>
										{(() => {
											const selectedType = selectedSlot.types.find(
												(t) => t.id === effectiveSlotTypeId,
											);
				...
				<div className="flex gap-2 p-4">
					...
					<Button
						...
						style={{
							background:
								bookingPrice && effectiveSlotTypeId ? "#00856F" : "#B0BEC5",
							color: "#FFFFFF",
						}}
					>
						{isBooking ? (
