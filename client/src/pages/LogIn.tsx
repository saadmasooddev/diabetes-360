...
export const LogIn = (): JSX.Element => {
  return (
    <div className="bg-white w-full min-w-[1440px] min-h-[1024px] flex">
      <section className="w-1/2 relative bg-[#f7f9f9]">
        <img
        ...
        <div className="absolute top-[55px] left-[57px] flex flex-col gap-[21px]">
          ...
          <div className="relative w-[436px] h-[79px]">
            <div className="absolute left-0 top-0 w-[68.81%] h-full bg-[#00856f] rounded-[5px]" />
            <h2 className="absolute top-0 left-0 w-[98.62%] h-full [font-family:'Open_Sauce_Sans-ExtraBold',Helvetica] font-extrabold text-white text-[64px] tracking-[-0.20px] leading-[normal]">
              Diabetes 360
            </h2>
          </div>
        </div>
      ...
      <section className="w-1/2 bg-[#f7f9f9] flex items-center justify-center">
        <div className="w-[447px] flex flex-col">
          <h2 className="[font-family:'Poppins',Helvetica] font-bold text-[#00856f] text-3xl tracking-[-0.30px] leading-[39px] mb-[77px]">
            Log in
          </h2>
          ...
          <Button className="w-[353px] h-14 bg-[#00856f] hover:bg-[#00856f]/90 rounded-[10px] mb-[19px]">
          ...
          <div className="flex gap-[15px] mb-[117px]">
