...
export function Settings() {
	...
	const { data: consultationQuotas, isLoading: isLoadingQuotas } =
		useGetConsultationQuotas();
			...
			<main className="flex-1 flex justify-center px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 overflow-x-hidden">
				<div className="w-full max-w-full" style={{ maxWidth: "1145px" }}>
					...
					>
						...
						>
							<TabsList
								className="inline-flex h-auto min-w-max sm:w-auto sm:flex-wrap gap-1 sm:gap-0 p-1 flex-nowrap"
												...
												<div>
													...
													<div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
														...
														<div>
															...
															<div className="mt-1 p-3 bg-gray-50 rounded-lg">
																<p className="text-sm text-gray-900">
																	{customerData.customerData.weight} kg
																</p>
															</div>
														</div>
														<div>
															...
															<div className="mt-1 p-3 bg-gray-50 rounded-lg">
																<p className="text-sm text-gray-900">
																	{customerData.customerData.height} cm
																</p>
															</div>
														</div>
														<div>
															...
															<div className="mt-1">
																<Badge variant="outline" className="capitalize">
																	{customerData.customerData.diabetesType
																		.replace("type", "Type ")
																		.replace("prediabetes", "Prediabetes")}
																</Badge>
															</div>
														</div>
													</div>
							...
							>
								...
								<CardContent className="p-4 sm:p-6 lg:p-6 pt-0">
									<div className="space-y-4 sm:space-y-6">
										<AccessControl
											permission={PERMISSIONS.READ_CONSULTATION_QUOTAS}
										>
											<div className="p-4 bg-teal-50 rounded-lg border border-teal-200">
												<h3 className="font-semibold text-sm sm:text-base text-teal-900 mb-3">
													Consultation Quotas
												</h3>
												{isLoadingQuotas ? (
													...
													<div className="space-y-3">
														<div className="flex items-center justify-between">
															...
															<span className="font-semibold text-teal-700">
																...
																/{" "}
																{consultationQuotas.quota.discountedQuotaLimit}
															</span>
														</div>
														<div className="flex items-center justify-between">
															<span className="text-sm text-gray-700">
																Free Consultations Left:
															</span>
															<span className="font-semibold text-teal-700">
																{consultationQuotas.quota.freeConsultationsLeft}{" "}
																/ {consultationQuotas.quota.freeQuotaLimit}
															</span>
														</div>
													</div>
												) : (
									...
									<div className="space-y-4 sm:space-y-6">
										...
										<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-4 bg-gray-50 rounded-lg">
											<div>
												...
												<p className="text-xs sm:text-sm text-gray-600">
													Reminders for medication and checkups
												</p>
											</div>
											<Switch
												defaultChecked
