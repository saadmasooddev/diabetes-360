...
export const fcmDeviceTypePgEnum = pgEnum(
  "fcm_device_type_enum",
  Object.values(FCM_DEVICE_TYPE_ENUM) as [string, ...string[]],
);

export const fcmDeviceTypeZodSchema = z.enum(
  Object.values(FCM_DEVICE_TYPE_ENUM),
);
...
export const pushMessageTypePgEnum = pgEnum(
  "push_message_type_enum",
  Object.values(PUSH_MESSAGE_TYPE_ENUM) as [string, ...string[]],
);

export const pushMessageTypeZodSchema = z.enum(
  Object.values(PUSH_MESSAGE_TYPE_ENUM),
);
...
export const usersFcmTokens = pgTable(
  ...
  (t) => [primaryKey({ columns: [t.userId, t.token, t.deviceType] })],
);
...
export type AppointmentBookedPushPayload = {};

export type AppointmentReminderPushPayload = {};
...
export type PushMessagePayload =
  ...
  | {
      type: typeof PUSH_MESSAGE_TYPE_ENUM.APPOINTMENT_BOOKED;
      title: string;
      body: string;
      data: AppointmentBookedPushPayload;
    }
  | {
      type: typeof PUSH_MESSAGE_TYPE_ENUM.APPOINTMENT_REMINDER;
      title: string;
      body: string;
      data: AppointmentReminderPushPayload;
    };
