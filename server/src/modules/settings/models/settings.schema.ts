...
export const insertFoodScanLimitsSchema = createInsertSchema(foodScanLimits).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
}).extend({
...
export const insertFoodScanLogsSchema = createInsertSchema(foodScanLogs).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
}).extend({
