...
const options: swaggerJsdoc.Options = {
	definition: {
		...
		info: {
			...
			version: "1.0.0",
			description:
				"Comprehensive API documentation for Diabetes 360 health management application",
			contact: {
				name: "API Support",
			},
		},
			...
			schemas: {
				Error: {
					...
					properties: {
						...
						data: {
							description:
								"Error response data - null for most errors, empty array [] for array endpoints",
							oneOf: [
								{ type: "null" },
								{ type: "array", items: {} },
								{ type: "object" },
				...
				User: {
					...
					properties: {
						...
						profileComplete: {
							...
							example: false,
							description:
								"Indicates if the user profile is complete (for customer role)",
						},
						profileData: {
							oneOf: [
							...
							nullable: true,
							description:
								"User profile data - CustomerData for customers, PhysicianData for physicians, null if profile not complete",
						},
						createdAt: {
							type: "string",
							format: "date-time",
				...
				HealthMetric: {
					...
					properties: {
						...
						heartRate: {
							...
							example: 72,
							description:
								"Heart rate in beats per minute (BPM). Only available for paid users.",
						},
						recordedAt: {
							type: "string",
							format: "date-time",
		...
		tags: [
			...
			},
			{
				name: "Food Scanner",
				description:
					"Food Scanner API integration endpoints for food scanning and nutrition analysis",
			},
			{
				name: "Two-Factor Authentication",
				description:
					"Two-factor authentication endpoints for TOTP-based security",
			},
		],
	},
	apis: ["./server/src/modules/**/routes/*.routes.ts"],
};
